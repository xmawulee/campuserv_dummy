...
export default function ProviderSignUpScreen({ navigation }: any) {
  ...
  const validate = (): boolean => {
    ...
    if (!name.trim()) {
      err.name = 'Full Name or Service Name is required.';
    ...
    if (!email.trim()) {
      ...
      err.email = 'Please use a valid KNUST email (@st.knust.edu.gh).';
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const userObj = {
        ...
        role: (userRole || 'PROVIDER') as 'STUDENT' | 'PROVIDER' | 'ADMIN',
        ...
        >
          ...
          >
            ...
            <Text style={[styles.subheading, { color: colors.textMuted }]}>
              Offer your services to students on campus.
            </Text>
            ...
            <View style={styles.form}>
              <Text style={[styles.label, { color: colors.textMuted }]}>Full Name or Service Name</Text>
              <TextInput
                ...
                placeholder="e.g. John Mensah or JM Laundry"
              ...
              >
                {isLoading ? (
                  ...
                  <View style={styles.submitBtnInner}>
                    <Text style={styles.submitBtnText}>Continue to ID Verification</Text>
            ...
            <View style={styles.footerRow}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('SignIn', { initialRole: 'PROVIDER' })} disabled={isLoading}>
